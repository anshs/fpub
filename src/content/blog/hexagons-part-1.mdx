...
ogImage: src/assets/images/hexagons-part-1/hex-part-1.png
githubLink: https://github.com/anshs/hex-breakout
link: https://github.com/anshs/hex-breakout
---
import InteractiveHex from "@assets/images/hexagons-part-1/hexagon-drawing.astro";
...
![A natural honeycomb - by [Marian Bijlenga](https://www.flickr.com/photos/marianbijlenga/3841529901/)](@assets/images/hexagons-part-1/honeycomb.png)
...
![Saturn’s north pole](@assets/images/hexagons-part-1/saturn-north-pole.png)
...
[Source code on Github](https://github.com/anshs/hex-breakout)

(Refresh the page once if you don't see anything below)
...
![Hexagon](@assets/images/hexagons-part-1/hexagon1.png)
...
![Transforming axial coordinates to cartesian coordinates](@assets/images/hexagons-part-1/Hex-trigonometry.png)
